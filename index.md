...
RESOLVED that the AFT calls on municipal and state governments and law enforcement agencies to cease using from "gang databases" with a low threshold for inclusion and to cease sharing such data with ICE and that the AFT calls for the federal government to cease using inclusion in such databases as a justification for apprehension and deportation. 
